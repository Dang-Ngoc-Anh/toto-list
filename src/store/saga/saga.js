...
import {  DELETE_FAILURE, DELETE_REQUEST, DELETE_SUCCESS, FETCH_FAILURE, FETCH_FAILURE_BY_ID, FETCH_REQUEST, FETCH_REQUEST_By_ID, FETCH_SUCCESS, FETCH_SUCCESS_BY_ID, POST_FAILURE, POST_REQUEST, POST_SUCCESS, PUT_FAILURE, PUT_REQUEST, PUT_SUCCESS, RESTORE_DONE_FAUILURE, RESTORE_DONE_REQUEST, RESTORE_DONE_SUCCESS, UPDATE_DONE_FAUILURE, UPDATE_DONE_REQUEST, UPDATE_DONE_SUCCESS} from "../../Utils/utils";
...
function* getTodoById(action){
    try {
        const res = yield getDataById(action.payload);
        yield put({ type: FETCH_SUCCESS_BY_ID, payload: res });
    } catch (err) {
        yield put({ type: FETCH_FAILURE_BY_ID, payload: err.message });
...
function* mySaga(){
    ...
    yield takeLatest(FETCH_REQUEST_By_ID , getTodoById);
